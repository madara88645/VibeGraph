                    ...
                    <div className="upload-modal" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Upload Project">
                        ...
                        {isAnalyzing ? (
                            ...
                            <div className="upload-actions" style={{ display: 'flex', gap: '10px', marginTop: '14px', marginBottom: '14px', flexWrap: 'wrap', justifyContent: 'center' }}>
                                <button type="button" disabled={isAnalyzing} className="upload-select-btn" onClick={(e) => { e.stopPropagation(); fileInputRef.current?.click(); }} style={{ minHeight: '44px', minWidth: '120px' }}>Browse Folder</button>
                                <button type="button" disabled={isAnalyzing} className="upload-select-btn" onClick={(e) => { e.stopPropagation(); zipInputRef.current?.click(); }} style={{ minHeight: '44px', minWidth: '120px' }}>Browse ZIP</button>
                            </div>
