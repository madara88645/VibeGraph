...
def _get_parsed_ast(
    ...
    # PERFORMANCE OPTIMIZATION (Bolt): Pre-compute splitlines and a dictionary index
    # mapping node names to their line boundaries. This avoids O(N) traversal overhead
    # per request, trading memory for speed via the lru_cache.
    lines = source.splitlines()
    nodes: dict[str, tuple[int, int | None]] = {}
