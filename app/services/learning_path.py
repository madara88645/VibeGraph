...
def _normalize_graph(
    ...
    # PERFORMANCE OPTIMIZATION (Bolt): Replaced dictionary comprehension
    # with native C-optimized dict.fromkeys() to significantly reduce
    # dictionary initialization overhead for large node sets.
